 ...
 * @author shobhit
 */
public class addScholarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String loc = request.getParameter("sch");
        ...
        try{
           ...
           Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/register?useSSL=true&verifyServerCertificate=false&allowMultiQueries=true","root","1810");
            PreparedStatement ps = con.prepareStatement("insert into scholarship  values(?,?,?)");
            ps.setString(1,cn);
            ps.setString(2,loc);
